...
// testy domyślne bez pytania użytkownika
            ...
            System.out.println("160 km = " + KonwersjaJednostek.kmtoml(160.0) + " mil" );
            System.out.println("10 km = " + KonwersjaJednostek.kmtoml(10.0) + " mil" );
            System.out.println();

            System.out.println("0 C = " + KonwersjaJednostek.ctofr(0.0) + " F" );
            System.out.println("100 C = " + KonwersjaJednostek.ctofr(100.0) + " F" );
            System.out.println("37 C = " + KonwersjaJednostek.ctofr(37.0) + " F" );

            System.out.println("0 F = " + KonwersjaJednostek.frtoc(0.0) + " C" );
            System.out.println("100 F = " + KonwersjaJednostek.frtoc(100.0) + " C" );
            System.out.println("32 F = " + KonwersjaJednostek.frtoc(32.0) + " C" );
